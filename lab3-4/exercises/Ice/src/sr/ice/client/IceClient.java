...
public class IceClient {
    public static void main(String[] args) {
        ...
        try {
            ...
            // (wówczas aplikację należy uruchomić z argumentem --Ice.config=config.client)
            ...
            ObjectPrx base1 = communicator
                    .stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); // opcja
                                                                                                               // -z
                                                                                                               // włącza
                                                                                                               // możliwość
                                                                                                               // kompresji
                ...
                try {
                    ...
                    switch (line) {
                        ...
                        case "op":
                            ...
                            break;
                        case "op2":
                            a = new A((short) 11, 22, 33.0f,
                                    "ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota ");
                            obj1.op(a, (short) 44);
                            System.out.println("DONE");
                            break;
                        case "op 10":
                        ...
                        case "add-asyn1":
                            obj1.addAsync(7000, 8000)
                                    .whenComplete((result, ex) -> System.out.println("RESULT (asyn) = " + result));
                            break;
                        ...
                        case "op-asyn1b 100":
                            ...
                            for (int i = 0; i < 100; i++) {
                                obj1.opAsync(a, (short) 99)
                                        .whenComplete((result, ex) -> System.out.println("CALL (asyn) finished"));
                            }
                            System.out.println("DONE");
                            break;
