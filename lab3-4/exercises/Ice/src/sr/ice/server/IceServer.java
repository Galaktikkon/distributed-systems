...
public class IceServer {
    public void t1(String[] args) {
        ...
        try {
            ...
            // METODA 2 (niepolecana, dopuszczalna testowo): Konfiguracja adaptera Adapter1
            // jest w kodzie źródłowym
            // ObjectAdapter adapter =
            // communicator.createObjectAdapterWithEndpoints("Adapter1", "tcp -h 127.0.0.2
            // -p 10000");
            // ObjectAdapter adapter =
            // communicator.createObjectAdapterWithEndpoints("Adapter1", "tcp -h 127.0.0.2
            // -p 10000 : udp -h 127.0.0.2 -p 10000");
            ...
            // 4. Dodanie wpisów do tablicy ASM, skojarzenie nazwy obiektu (Identity) z
            // serwantem
